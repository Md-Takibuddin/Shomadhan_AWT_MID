        ...
        <aside class="col-span-2 | bg-white">
            <div class="sticky top-0 left-0 h-screen flex flex-col overflow-x-auto | p-4">
                ...
                <nav class="flex flex-col space-y-4 mt-10">
                    <a class="nav_item" href="/student-dashboard">
                        <img
                    ...
                    <a class="nav_item" href="student-question">
                        <img
                    ...
                    <a class="nav_item" href="student-appointment">
                        <img
                    ...
                    <a class="nav_item" href="student-settings">
                        <img
                    ...
                    <a class="nav_item" href="student-login">
                        <img
                ...
                <section class="relative | flex flex-col space-y-7 | mt-auto px-5 pb-5">
                    <div class="relative | z-10 flex flex-col space-y-4">
                        ...
                        <button class="bg-purple py-3 px-5 rounded-xl text-white font-semibold hover:shadow-xl transition-all ease-in-out duration-300">
                            Upgrade Now
                        </button>
                    </div>
                    <div class="absolute h-[60%] w-full left-0 bottom-0 z-0 | bg-purple bg-opacity-60 rounded-xl"></div>
                </section>
            </div>
        </aside>
    );
