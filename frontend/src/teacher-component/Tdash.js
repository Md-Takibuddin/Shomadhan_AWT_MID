...
<div><a href="/teacher-ques"><button className="button-36" role="button">{dummy1} <br/>Question Pending</button></a></div>
<div><a href="/teacher-appointment"><button className="button-37" role="button">{dummy2} <br/>Appointment List</button></a></div>
<div><a href="/teacher-showans"><button className="button-38" role="button">{dummy3} <br/>Question Answered</button></a></div>
</div>
</html>
